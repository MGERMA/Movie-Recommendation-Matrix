...
<title>PRFlix</title>
<style>body * {font-family: 'Andale Mono', monospace; color : white} a {text-decoration: none;}</style>
...
<div style="text-align: right"><a href="LogoutServlet">Se déconnecter</a></div>
...
<input class="search" type="text" placeholder="Rechercher un film en particulier" style="color = black")><span class="bar"></span>
</div>
</div>
</div>
</div>
...
<div class="unfilm">
<img class="pochette" src="pochettes/dumbo.jpg">

<img class="pochette" src="pochettes/shazam.jpg">
<img class="pochette" src="pochettes/Chamboultout.jpg">
<img class="pochette" src="pochettes/captainMarvel.jpg">
